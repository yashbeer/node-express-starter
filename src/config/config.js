...
const envVarsSchema = Joi.object()
  .keys({
    ...
    DB_NAME: Joi.string().required().description('SQLite database filename'),
    ...
    OTP_COOLDOWN_MINUTES: Joi.number().default(1).description('minutes to wait before requesting another OTP'),
  })
  .unknown();
...
module.exports = {
  ...
  otp: {
    ...
    cooldownMinutes: envVars.OTP_COOLDOWN_MINUTES,
  },
};
