...
The environment variables can be found and modified in the `.env` file. An example env file could be found at `.env.example`
...
The `filter` param is a regular query filter.
